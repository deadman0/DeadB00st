...
/tmp/busybox cp /system/etc/DB/Cpu.conf /tmp/Cpu.conf
/tmp/busybox chmod 755 /tmp/Cpu.conf

/tmp/busybox mkdir /tmp/Cpu
/tmp/busybox cp /system/etc/DB/Cpu/* /tmp/Cpu/
/tmp/busybox chmod 755 /tmp/Cpu/*
